        ...
        <header className="flex flex-col md:flex-row md:text-left gap-[20px] w-full md:gap-0 md:relative items-center">
                {/* <Slide left duration={2000}> */}
                    <picture className="bg-[#151515] xl:pl-[32%] lg:pl-[28%]  xl:h-[700px]">
                        ...
                        srcSet="./src/assets/desktop/image-hero@2x.jpg 2x"
                        >
                        </source>
                        <source
                        media="(min-width: 640px)"
                        srcSet="./src/assets/tablet/image-hero@2x.jpg 2x"
                        >
                        </source>
                        <img className="md:max-h-[700px] lg:h-full lg:w-full" src="./src/assets/mobile/image-hero@2x.jpg 2x" alt=""></img>
                    </picture>
                {/* </Slide> */}
        ...
        {/* <Fade delay={1000} duration={2000}> */}
            ...
            <div className="flex flex-col md:flex-row items-center xl:justify-between ">
                    <picture className="w-full md:order-2">
                        <source
                        media="(min-width: 1024px)"
                        srcSet="./src/assets/desktop/image-grid-1@2x.jpg 2x"
                        />
                        <source
                        media="(min-width: 640px)"
                        srcSet="./src/assets/tablet/image-grid-1@2x.jpg 2x"
                        />
                        <img className="md:h-[400px] md:w-[400px] lg:w-full object-cover" src="./src/assets/mobile/image-grid-1@2x.jpg 2x" alt=""/>
                    </picture>
            ...
            <div className="flex flex-col gap-4 md:flex-row ">
                <div>
                    <picture>
                        <source
                        media="(min-width: 1024px)"
                        srcSet="./src/assets/mobile/image-grid-2@2x.jpg 2x"
                        />
                        <source
                        media="(min-width: 640px)"
                        srcSet="./src/assets/tablet/image-grid-2@2x.jpg 2x"
                        />
                        <img className="h-full w-full" src="./src/assets/mobile/image-grid-2@2x.jpg 2x" alt=""/>
                    </picture>
                </div>
                <div className="flex flex-col gap-4">
                    <picture className="">
                        <source
                        media="(min-width: 1024px)"
                        srcSet="./src/assets/desktop/image-grid-3@2x.jpg 2x"
                        />
                        <source
                        media="(min-width: 640px)"
                        srcSet="./src/assets/tablet/image-grid-3@2x.jpg 2x"
                        />
                        <img className="h-full w-full" src="./src/assets/mobile/image-grid-3@2x.jpg 2x" alt=""/>
                    </picture>
